                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img id="circle" class="refresh" widht="250" height="250"
                        ...
                        <div class="text-center">
                            <label class="font-wight-bold h5">Your bet</label>
                            ...
                            <hr>
                            <p class="font-wight-bold h5">Remaining Time</p>
                            <p id="timer" class="h5 text-danger">Waiting to start</p>
                            <hr>
                            <p id="result" class="h1">
                        </div>
                    </div>
                </div>
            </div>
